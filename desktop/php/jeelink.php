  ...
  <div class="col-lg-2 col-md-3 col-sm-4">
    <div class="bs-sidebar">
      <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
        <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un équipement cible}}</a>
...
?>
 ...
 <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
  ...
  <div class="cursor" id="bt_jeelinkMasterConfiguration" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;">
    <center>
      <i class="fa fa-wrench" style="font-size : 6em;color:#767676;"></i>
    </center>
    <span style="font-size : 1.1em;position:relative; top : 15px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Configurer les jeedoms cibles}}</center></span>
  </div>
</div>
    ...
    <form class="form-horizontal">
      <fieldset>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label">{{Nom de l'équipement Jeelink}}</label>
          <div class="col-sm-3">
...
<?php include_file('desktop', 'jeelink', 'js', 'jeelink');?>
